...
input.addEventListener('input',() => {
    document.querySelector('#text').innerHTML = mysearch(input.value, txt, ['<span class="highlight">','</span>']);
...
Цветовая подсветка текста при вводе - строгий поиск точно введенной фразы
...
// https://codepen.io/anon/pen/MRPBZG
// https://codepen.io/ArcCode/pen/zXmyqX
